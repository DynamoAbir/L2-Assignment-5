...
const Header = () => {
  ...
  return (
    <header className="w-full bg-secondary text-primary body-font shadow-sm ">
      {/* :DESKTOP MENU */}
      <div className="container mx-auto flex justify-between items-center py-7 px-5">
        ...
        >
          <span className="ml-3 text-3xl font-matemasie text-primary font-bold antialiased">
            RoCkLand
          </span>
        </a>
        {/* ::Navbar */}
        <nav className="hidden md:flex flex-wrap items-center justify-center text-base tracking-wide">
          <a href="#link" className="mr-8 hover:text-white">
            Solutions
          </a>
          <a href="#link" className="mr-8 hover:text-white">
            Prices
      ...
      {/* ::MOBILE MENU */}
      {isOpen && (
        <div className="w-full flex flex-col py-4 px-3 md:hidden bg-secondary text-base uppercase text-center font-semibold">
          <a
            href="#link"
            className="block px-3 py-2 rounded-md text-primary hover:text-white hover:bg-primary"
          >
            Solutions
          </a>
          <a
